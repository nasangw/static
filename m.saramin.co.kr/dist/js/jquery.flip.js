...
/*
     FILE ARCHIVED ON 7:24:55 Jan 28, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 7:24:55 Jan 28, 2019.
 ...
 * /save/https://github.com/nnattawat/flip
...
(function( $ ) {
    ...
    // Function from David Walsh: /save/http://davidwalsh.name/css-animation-callback licensed with /save/http://opensource.org/licenses/MIT
    ...
    $.fn.flip = function(options, callback) {
        ...
        this.each(function(){
            ...
            if (options !== undefined && (typeof(options) == "boolean" || typeof(options) == "string")) { // Force flip the DOM
                ...
                else if (settings.trigger.toLowerCase() == "auto") {        // auto 추가 커스터마이징;
                    setTimeout(function() {
                        flip($dom)
                    }, (settings.speed + 150));
                    setTimeout(function() {
